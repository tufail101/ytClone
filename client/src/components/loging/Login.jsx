  ...
  return (
    <>
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900">
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 text-white shadow-2xl rounded-3xl p-10 w-96">
          ...
          <p>Don't have an account?</p> <Link to="/singup">Sing Up</Link>
          </div>
        </div>
      </div>
    </>
